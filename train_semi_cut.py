...
from pseudo.dataset.augs_ALIA import cut_mix, cut_mix_label_adaptive, cut_mix_label_inject, cut_mix_out_adaptive, cut_mix_slabel_inject, cut_out
    ...
    for step in range(len(loader_l)):
        ...
        if epoch < cfg["trainer"].get("sup_only_epoch", 0):
            ...
            if cfg["trainer"]["unsupervised"].get("use_strong", False):
                ...
                elif cfg["trainer"]["unsupervised"].get("use_cutout_adaptive", False):
                ...
                elif cfg["trainer"]["unsupervised"].get("use_cutmix_slabelinj", False):
